...
ArduinoSMBus battery(0x0A); // Replace with your battery's address
...
void loop() {
  ...
  Serial.print("Battery System State: ");
  Serial.println(battery.batterySystemState(), BIN);
  Serial.print("Battery System State Continued: ");
